...
func (x *NotiRequest) GetNotification() string {
	if x != nil {
...
func (x *NotiReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotiReply) ProtoMessage() {}

func (x *NotiReply) ProtoReflect() protoreflect.Message {
	mi := &file_notification_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotiReply.ProtoReflect.Descriptor instead.
func (*NotiReply) Descriptor() ([]byte, []int) {
	return file_notification_proto_rawDescGZIP(), []int{1}
}

func (x *NotiReply) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_notification_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x6d, 0x79, 0x67, 0x72, 0x70, 0x63, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x22, 0x31, 0x0a, 0x0b, 0x4e, 0x6f, 0x74, 0x69, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x25, 0x0a, 0x09, 0x4e, 0x6f, 0x74, 0x69, 0x52, 0x65,
	...
	0x0b, 0x4e, 0x6f, 0x74, 0x69, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x07,
	0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x12, 0x1a, 0x2e, 0x6d, 0x79, 0x67, 0x72, 0x70, 0x63,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x6d, 0x79, 0x67, 0x72, 0x70, 0x63, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42,
...
var file_notification_proto_goTypes = []interface{}{
	(*NotiRequest)(nil), // 0: mygrpcservice.NotiRequest
	(*NotiReply)(nil),   // 1: mygrpcservice.NotiReply
}
var file_notification_proto_depIdxs = []int32{
	0, // 0: mygrpcservice.NotiService.GetNoti:input_type -> mygrpcservice.NotiRequest
	1, // 1: mygrpcservice.NotiService.GetNoti:output_type -> mygrpcservice.NotiReply
